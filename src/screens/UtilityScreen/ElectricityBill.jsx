...
const ElectricityBillPaymentScreen = ({navigation}) => {
  ...
  const handlePayment = () => {
    if (!consumerNumber || !board || !amount) {
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.pickerContainer}>
            <Picker
              selectedValue={board}
              onValueChange={itemValue => setBoard(itemValue)}
              style={{color: board ? '#000' : '#999'}}>
              <Picker.Item label="Select Board" value="" />
              <Picker.Item label="BSES Rajdhani" value="bses_rajdhani" />
              <Picker.Item label="BSES Yamuna" value="bses_yamuna" />
              <Picker.Item label="Tata Power" value="tata_power" />
              <Picker.Item label="Adani Electricity" value="adani" />
              <Picker.Item label="UPPCL" value="uppcl" />
            </Picker>
          </View>
