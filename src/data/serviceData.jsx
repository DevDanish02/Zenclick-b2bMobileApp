...
export const rechargeAndBillPayment = [
  [
    ...
    {
      icon: color => <Entypo name="landline" size={30} color={color} />,
      title: 'Land Line',
      screen: 'LandLine',
    },
    {
      icon: color => <Ionicons name="tv-outline" size={30} color={color} />,
      title: 'DTH',
      screen: 'DTH',
    },
    {
      icon: color => <FontAwesome6 name="cable-car" size={30} color={color} />,
      title: 'Cable',
      screen: 'Cable',
    },
    {
    ...
    {
      icon: color => <FontAwesome5 name="house-user" size={30} color={color} />,
      title: 'Housing Society',
      screen: 'HousingSociety',
    },
    {
      icon: color => <FontAwesome5 name="hospital" size={30} color={color} />,
      title: 'Hospital',
      screen: 'Hospital',
    },
    {
